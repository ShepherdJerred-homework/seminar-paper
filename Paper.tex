...
\section{VEOs}
% TODO VBOs can be repetitive, VEOs allow us to reduce this. Show how to use VEOs with a code sample. Create a simple cube/triangle with VEOs and then render it. Then show the loading of a complex model and render it.
